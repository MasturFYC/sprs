...
COPY public.acc_code (id, name, acc_type_id, descriptions, token_name, is_active) FROM stdin;
...
1112	Bank BCA 0856212654	11	Rekening BCA Opik	'0856212654':3 'bank':1 'bca':2,5 'opik':6 'reken':4	t
...
15	Perlengkapan	Barang2 yg bisa dipakai berulang-ulang dan habis, bentuknya relatif kecil umunya untuk melengkapi kebutuhan perusahaan
12	Piutang	Piutang adalah tagihan yang dipinjamkan kepada pelanggan dan wajib dilunasi paling lama satu tahun atau menurut kesepakatan
21	Hutang Usaha	Pinjaman uang dari pihak yang dilakukan seseorang kepada perusahaan, tidak hanya uang bisa juga barang atau jasa
22	Hutang Bank	Pinjaman yang diberikan oleh bank kepada perusahaan yg harus dibayar oleh perusahaan selama periode berikut bunganya
23	Hutang Lainnya	Semua utang yg diklasifikasikan sbg utang yg tidak lancar.
31	Modal Usaha	Segala sesuatu yang dipergunakan untuk membangun atau memulai sebuah usaha, tergantung pada jenis usaha yang dijalankan
32	Prive	Investor yang menarik kembali modal atau aset mereka dari suatu perusahaan dgn maksud untuk digunakan sendiri oleh pemiliknya
41	Pendapatan Jasa	Arus masuk bruto dari kegiatan usaha yg mengakibatkan kenaikan ekuitas yang tidak berasal dari kontribusi modal
42	Pendapatan Lainnya	Arus masuk bruto dari kegiatan di luar usaha yg mengakibatkan kenaikan ekuitas yang tidak berasal dari kontribusi modal
52	Biaya Operasional	Biaya yg dikeluarkan untuk aktivitas harian perusahaan seperti komisi, transportasi, sewa, perbaikan, pajak
53	Biaya Gaji	Biaya yg dikeluarkan untuk gaji atau tunjangan
54	Biaya Tenaga Kerja	Biaya yg dikeluarkan untuk membayar upah tenaga kerja
\.
...
8	88258-E	2022-03-01	2022-03-04	1300000.00	20.00	1040000.00	0.00	Opick	\N	\N	1	1	0.00	260000.00	f	200000.00	1500000.00	'-01':5 '-03':4 '00':7 '00z':8 '1000':23 '2015':27 '2022':3 '2581':20 '4':30 '88258':1 'ada':18 'auto':10 'baf':12 'biru':26 'brio':22 'bussan':9 'e':2,19 'finance':11 'gudang':24 'honda':28 'jatibarang':13 'mastur':14 'patrol':25 'pbf':21 'r4':31 'roda':29 'stnk':16 'stnk-tidak-ada':15 't00':6 'tidak':17
9	X-256/BAF/VII/2002	2022-01-07	2022-01-07	1700000.00	20.00	1360000.00	0.00	Opick	test	\N	3	1	0.00	340000.00	t	0.00	1700000.00	'-01':5 '-07':6 '-256':2 '/baf/vii/2002':3 '00':8 '00z':9 '125':21 '2':31 '2022':4,25 'ada':18 'dodo':28 'e5968ghj':19 'finance':12 'fino':20 'gudang':22 'hitam':24 'jatibarang':14 'mandir':10 'mastur':15 'mata':26 'motor':27 'mtf':13 'pusat':23 'r2':32 'roda':30 'stnk':17 'stnk-ada':16 't00':7 'tunas':11 'x':1 'yamaha':29
\.
...
7	1	0	TRX-Umum	Penagihan invoice ke Adira Finance	2022-03-08	Tagihan masuk ke rekening punya kantor.	'7':1 'adira':5 'agih':2 'finance':6 'invoice':3 'kantor':12 'ke':4,9 'masuk':8 'punya':11 'rekening':10 'tagih':7 'trx':14 'trx-umum':13 'umum':15
8	3	0	TRX-Umum	Modal masuk dari pak Kris	2022-01-07	\N	'8':1 'dari':4 'kris':6 'masuk':3 'modal':2 'pak':5 'trx':8 'trx-umum':7 'umum':9
9	2	0	TRX-Umum	Beli rokok + kopi pak Mastur	2022-02-03	\N	'9':1 'beli':2 'kopi':4 'mastur':6 'pak':5 'rokok':3 'trx':8 'trx-umum':7 'umum':9
11	2	0	TRX-Umum	Beli 1 perangkat komputer di toko Armada	2022-03-02	\N	'1':3 '11':1 'angkat':4 'armada':8 'beli':2 'di':6 'komputer':5 'toko':7 'trx':10 'trx-umum':9 'umum':11
15	2	9	TRX-Order	Piutang jasa Mandiri Tunas Finance (MTF) #Order SPK: X-256/BAF/VII/2002	2022-03-09	R2 Yamaha Fino 125  - E5968GHJ	'-256':11 '/baf/vii/2002':12 '0':1 '125':16 'e5968ghj':17 'finance':6 'fino':15 'jasa':3 'mandir':4 'mtf':7 'order':8,20 'piutang':2 'r2':13 'spk':9 'trx':19 'trx-order':18 'tunas':5 'x':10 'yamaha':14
\.
...
1	5116	11	15000000.00	0.00
2	1111	11	0.00	15000000.00
1	1211	15	1360000.00	0.00
2	1112	15	0.00	1360000.00
\.
...
SELECT pg_catalog.setval('public.trx_seq', 15, true);
